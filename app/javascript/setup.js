...
import ShowUser from './components/show-user.vue';
Vue.component('show-user', ShowUser);

import UserFollowing from './components/user_following.vue';
Vue.component('user_following', UserFollowing);
